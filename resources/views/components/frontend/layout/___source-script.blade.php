<script>
    (function($) {
            ...
            $(".newsletter-form").validator().on("submit", function(event) {
                if (event.isDefaultPrevented()) { // Handle The
                    Invalid Form...formErrorSub();
                    submitMSGSub(false, "Please enter your email correctly");
                } else { // Everything
                    Looks Good!event.preventDefault();
                }
            });
            ...
            $(".newsletter-form").ajaxChimp({
                ...
                Your url MailChimp callback: callbackFunction
            }); // Back To Top $('body').append("<div class='go-top'><i
            class = 'bx bx-caret-up' > < /i></div > ");
            $(window).on('scroll', function() {
            ...
            $('.go-top').on('click', function() {
                    $('html,
                        ...
                        0 ' , }, 500 ); }); // Preloader JS jQuery(window).on('
                        load ',function(){
                        jQuery(".preloader").fadeOut(500);
                    }); //WOW JS new WOW().init(); // Switch Btn $('body').append("<div
                class = 'switch-box' > < label id = 'switch'

                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                                <div class="input-group ">
                                    ...
                                    <input wire:model="single_skill.skill" type="text" class="form-control @error('single_skill.skill') is-invalid @enderror" id="edit_skill">
                                </div>
                                <!-- /.input-group -->


                                <div class="form-text sentence_case">
                                    @if ($errors->has('single_skill.skill'))
                                    {{ $errors->first('single_skill.skill') }}
                                    @else
                                    {{ $single_skill['help_text'] }}
                                    @endif
                                </div>
                                <!-- /.form-text -->
                            </div>
